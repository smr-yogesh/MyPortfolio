...
<body>
            ...
            <div class="serv-content">
                ...
                <div class="card">
                    <div class="box">
                        ...
                        <div class="text">SEO and E-commerce</div>
                        <p>Currently I'm doing internship with an E-commerce website.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
    ...
    <section class="contact" id="contact">
        <div class="max-width">
            ...
            <div class="contact-content">
                ...
                <a href="https://www.facebook.com/Thesmr.me" target="blank">
                    <img src="icons/fb.png" alt="facebook" width="50" height="50" style="margin: 5px 5px;" >
                  </a>
                  <a href="https://www.instagram.com/smryogesh/" target="blank">
                    <img src="icons/insta.png" alt="Instagram" width="50" height="50" style="margin: 5px 5px;">
                  </a>
                  <a href="https://twitter.com/smryogesh" target="blank">
                    ...
                    <form class="contact-form" action="#" method="POST">
                        <div class="fields">
                            <div class="field name">
                                <input name="name" type="text" class="fullname" placeholder="Name">
                            </div>
                        ...
                        <div class="button-area">
                            <button onclick="popup()" class="send-msg" type="submit" name="send">Send message</button>
                        </div>
    ...
    <footer>
        <span>Created By <a href="http://yogeshbhatt.info.np">Yogesh Bhatt</a> | <span class="far fa-copyright"></span> 2020 All rights reserved.</span>
    </footer>
